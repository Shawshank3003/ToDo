...
public class TaskReaderDbHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + TaskReaderContract.TaskEntry.TABLE_NAME + " (" +
                    ...
                    TaskReaderContract.TaskEntry.COLUMN_NAME_TASK_DESCRIPTION + " TEXT," +
                    TaskReaderContract.TaskEntry.COLUMN_NAME_TASK_DUE_DATE + " TEXT," +
                    TaskReaderContract.TaskEntry.COLUMN_NAME_TASK_DUE_TIME + " TEXT)";
